<?php /* Smarty version Smarty-3.1.7, created on 2017-05-17 13:17:37
         compiled from "D:\OpenServer\domains\vtigercrm6.5.kg\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14432591c2341eaa493-14275331%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44674c8bc3e1618672a7430a5c63f4c1e06f7320' => 
    array (
      0 => 'D:\\OpenServer\\domains\\vtigercrm6.5.kg\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsEdit.tpl',
      1 => 1477914554,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14432591c2341eaa493-14275331',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_591c23427f94e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591c23427f94e')) {function content_591c23427f94e($_smarty_tpl) {?>
...
</span></div><select class="chzn-select lineItemTax" id="taxtype" name="taxtype" style="width: 164px;"><OPTION value="group_tax_inc" <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_INC_TYPE']->value){?>selected<?php }?>><?php echo vtranslate('LBL_GROUP_TAX_INC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</OPTION></select></div></th></tr><tr><td><b><?php echo vtranslate('',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b><?php }?></div></td><td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'){?><span class="pull-right"><input id="received" name="received" type="text" class="lineItemInputBox" data-validation-engine="validate[funcCall[Vtiger_PositiveNumber_Validator_Js.invokeValidation]]" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('received')&&!($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)){?><?php echo number_format($_smarty_tpl->tpl_vars['RECORD']->value->get('received'),$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('no_of_currency_decimals'),'.','');?>
<?php }else{ ?>0.00<?php }?>"></span><?php }else{ ?><span class="pull-right"><input id="paid" name="paid" type="text" data-validation-engine="validate[funcCall[Vtiger_PositiveNumber_Validator_Js.invokeValidation]]" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('paid')&&!($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)){?><?php echo number_format($_smarty_tpl->tpl_vars['RECORD']->value->get('paid'),$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('no_of_currency_decimals'),'.','');?>
