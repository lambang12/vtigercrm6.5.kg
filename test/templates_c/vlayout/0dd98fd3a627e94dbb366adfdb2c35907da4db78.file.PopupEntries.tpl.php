<?php /* Smarty version Smarty-3.1.7, created on 2017-05-17 13:17:43
         compiled from "D:\OpenServer\domains\vtigercrm6.5.kg\includes\runtime/../../layouts/vlayout\modules\Inventory\PopupEntries.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21909591c2347ed2450-75349778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0dd98fd3a627e94dbb366adfdb2c35907da4db78' => 
    array (
      0 => 'D:\\OpenServer\\domains\\vtigercrm6.5.kg\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\PopupEntries.tpl',
      1 => 1450875195,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21909591c2347ed2450-75349778',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_591c234839478',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591c234839478')) {function content_591c234839478($_smarty_tpl) {?>
...
.</div></div><?php }else{ ?><div class="row-fluid"><!-- SalesPlatform.ru begin --><div class="emptyRecordsDiv"><?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
.</div><!--<div class="emptyRecordsDiv"><?php echo vtranslate('LBL_EQ_ZERO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['RELATED_MODULE']->value,$_smarty_tpl->tpl_vars['RELATED_MODULE']->value);?>
 <?php echo vtranslate('LBL_FOUND',$_smarty_tpl->tpl_vars['MODULE']->value);?>
.</div>--><!-- SalesPlatform.ru end --></div><?php }?><?php }?></div><?php if ((!empty($_smarty_tpl->tpl_vars['SUBPRODUCTS_POPUP']->value))&&(!empty($_smarty_tpl->tpl_vars['PARENT_PRODUCT_ID']->value))){?><div class="row-fluid" style="margin-top:10px"><div class="span6">&nbsp;</div><div class="span6"><div class="pull-right"><button type="button" class="btn" id="backToProducts"><strong><?php echo vtranslate('LBL_BACK_TO_PRODUCTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
