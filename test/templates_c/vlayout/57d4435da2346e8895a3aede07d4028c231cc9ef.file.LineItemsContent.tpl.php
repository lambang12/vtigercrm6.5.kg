<?php /* Smarty version Smarty-3.1.7, created on 2017-05-17 13:17:38
         compiled from "D:\OpenServer\domains\vtigercrm6.5.kg\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28953591c2342cea605-40171119%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '57d4435da2346e8895a3aede07d4028c231cc9ef' => 
    array (
      0 => 'D:\\OpenServer\\domains\\vtigercrm6.5.kg\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsContent.tpl',
      1 => 1450875195,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28953591c2342cea605-40171119',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_591c2343832b0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591c2343832b0')) {function content_591c2343832b0($_smarty_tpl) {?>
...
" class="smallInputBox pull-right discount_amount discountVal <?php if (empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['checked_discount_amount']->value])){?>hide<?php }?>"/></td></tr></table><div class="modal-footer lineItemPopupModalFooter modal-footer-padding"><div class=" pull-right cancelLinkContainer"><a class="cancelLink" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 ...
 :</b></div><div class="individualTaxContainer <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value||$_smarty_tpl->tpl_vars['IS_GROUP_TAX_INC_TYPE']->value){?>hide<?php }?>">(+)&nbsp;<b><a href="javascript:void(0)" class="individualTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" align="right" class="productTaxTotal <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value||$_smarty_tpl->tpl_vars['IS_GROUP_TAX_INC_TYPE']->value){?>hide<?php }?>"><?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['taxTotal']->value];?>
